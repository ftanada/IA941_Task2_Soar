...
public class Environment
{
    ...
    public Environment(Boolean prepareEnviromentAndStartGame, Boolean resetWorld)
    {
        proxy = new WS3DProxy();
        //proxy.connect();
        try {
        ...
        // FMT 14/04/2017 just reset world if requested
        if (resetWorld) {
          w.reset();
        }
        ...
        // FMT 09/04/17 - other initializations
        c.updateBag();
        c.genLeaflet();
